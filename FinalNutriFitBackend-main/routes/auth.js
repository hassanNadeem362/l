...
const { regUser,userInfo, regNutritionist, loginUser, loginWithGoogleUser, updateUserInfo, getForgotPassword, getUserInfo, updateProfile, fetchAllUsers } = require('../controllers/authControllers');
