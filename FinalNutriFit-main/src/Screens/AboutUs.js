    ...
    <div>
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
          ...
          <p className="mt-1 text-gray-600 dark:text-green-700">
            Creative people
          </p>
        </div>
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-12">
          <div
            ...
            // style={{ boxShadow: "0px 44px 82px 4px rgba(0, 183, 34, 0.75)" }}
          >
            <img
              className="rounded-lg w-20 h-20 drop-shadow-md hover:drop-shadow-2xl"
              alt="No alt"
              src="https://randomuser.me/api/portraits/lego/2.jpg"
            />
            <div className="sm:flex sm:flex-col sm:h-full">
              <div className>
                <h3 className="font-medium text-black">Umer Ijaz</h3>
                <p className="mt-1 text-xs uppercase text-gray-500">Leader</p>
              </div>
          ...
          <div className="grid sm:flex sm:items-center gap-y-3 gap-x-4">
            ...
            <div className="sm:flex sm:flex-col sm:h-full">
              <div className>
                <h3 className="font-medium text-black">Mauhammad Zain</h3>
                <p className="mt-1 text-xs uppercase text-gray-500">Member</p>
              </div>
              <div className="mt-2 sm:mt-auto space-x-2.5">
                <a
                  className="inline-flex justify-center items-center text-gray-500 hover:text-gray-800 dark:hover:text-gray-200"
          ...
          <div className="grid sm:flex sm:items-center gap-y-3 gap-x-4">
            ...
            <div className="sm:flex sm:flex-col sm:h-full">
              <div className>
                <h3 className="font-medium text-black">Muhammad Ali</h3>
                <p className="mt-1 text-xs uppercase text-gray-500">Member</p>
              </div>
              <div className="mt-2 sm:mt-auto space-x-2.5">
                <a
          ...
          <div className="grid sm:flex sm:items-center gap-y-3 gap-x-4">
            ...
            <div className="sm:flex sm:flex-col sm:h-full">
              <div className>
                <h3 className="font-medium text-black">Muhammad Ajlal</h3>
                <p className="mt-1 text-xs uppercase text-gray-500">Member</p>
              </div>
              <div className="mt-2 sm:mt-auto space-x-2.5">
                <a
      ...
      <div className="bg-green-400 p-20 mt-28 ml-40 mr-40 rounded-2xl bottom-0">
