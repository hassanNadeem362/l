      ...
      <div className="border-2 mt-10 ml-96 mr-96 rounded-xl p-16 drop-shadow-xl ">
        ...
        <div>
          ...
          <p className="text-center mb-5">
            We'd like to understand how often you participate in physical
            activity to better guide you.
          </p>
          ...
          <div className="text-lg ml-5 mb-5 border-2 rounded-lg p-1 hover:bg-green-400 ">
            <label>
              <input
                ...
                type="radio"
                value="other"
                checked={workoutFrequency === "other"}
                onChange={() => setWorkoutFrequency("other")}
              />
              Other
            </label>
          </div>
