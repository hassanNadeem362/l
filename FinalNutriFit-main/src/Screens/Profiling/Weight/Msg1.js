      ...
      <div className="mt-6 ml-96 mr-96 rounded-xl p-16 drop-shadow-2xl border-2">
        <div className="">
          <h1 className="font-bold text-lg text-center">
            Well done! You've taken a significant stride in the right direction
          </h1>
          <br />
          <h1 className="text-center">
            {" "}
            Did you know that keeping track of what you eat can really help you
            succeed? It's like watching out for yourself, and the more you do
            it, the better your chances of reaching your goals.
            <br /> <br /> Now, let's discuss your aim to increase your weight.
          </h1>
        </div>
        <br />
